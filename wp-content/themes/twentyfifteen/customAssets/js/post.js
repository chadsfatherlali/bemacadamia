/**
 * Created by chadsfather on 7/6/15.
 */
/*
...
(function($, _) {
    ...
    /* FORM */
    function getObjectfromSerialize(items) {
        var objeto = {};
    ...
    $form.validate({
        submitHandler: function(form) {
            ...
            values = getObjectfromSerialize(values);
            values.hash = $.cookie('cart');

            $.post('/vendor/cart/cart.php?accion=save', values, function(response) {
                if (response !== 'ko') {
                    $form[0].reset();
        ...
        messages: {
            ...
            cantidad: {
                min:'El valor debe ser minimo 1'
            },
            color: {
